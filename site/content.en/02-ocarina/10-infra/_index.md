...
| 06  | [`06-playwright-actor.md`](06-playwright-actor.md)   | The `PlaywrightDriver` actor: owner thread, marshalling through `submit`, the `call_timeout` liveness ceiling, cross-thread warmup, observe-only Watcher. |
