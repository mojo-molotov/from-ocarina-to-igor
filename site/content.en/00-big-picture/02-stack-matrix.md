...
| ------------------------- | -------------------------------------------------------------------------------------------- | ---------- | :-------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------ | :-----: |
| `ocarina`                 | Browser e2e test framework                                                                   | Python     | **3.14+** | `hatchling`, `python-docx` (sole runtime dependency), `selenium` + `playwright` (dev only)                                                                                            | `ruff` (ALL), `mypy` strict, `pytest`, `hypothesis`, `pytest-mypy-plugins`, `syrupy`, `prysk` (cram), `allure-pytest`, `pre-commit`, `twine`, `build`                                                                                      | PyPI, v**1.1.3**                           |   MIT   |
