...
| ------------------------- | -------------------------------------------------------------------------------------------- | ---------- | :-------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------ | :-----: |
| `ocarina`                 | Browser e2e test framework                                                                   | Python     | **3.14+** | `hatchling`, `python-docx` (sole runtime dependency), `selenium` + `playwright` (dev only)                                                                                            | `ruff` (ALL), `mypy` strict, `pytest`, `hypothesis`, `pytest-mypy-plugins`, `syrupy`, `prysk` (cram), `allure-pytest`, `pre-commit`, `twine`, `build`                                                                                      | PyPI, v**1.1.10**                          |   MIT   |
...
- Neither Selenium nor Playwright (added in `1.1.3`) is a runtime dep of Ocarina. Both sit in the _dev_ group&nbsp;—&nbsp;used by the framework's tests and shipped adapters, not by the library core itself.
