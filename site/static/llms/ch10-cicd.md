...
| `02-ocarina-workflows.md` | `ocarina` repo: `main_ci.yml` (full build + tests ubuntu × windows × py 3.14), `dev_ci.yml` (check-coding-style + tests), `unstable_python_full_build.yml` (monthly cron on Python pre-release, 1st of month). |
