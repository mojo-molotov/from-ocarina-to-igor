...
| `02-auditability.md` | "Auditable in an afternoon": 1 runtime dependency, ~3 000 lines, MIT. Anti-No-Code. |
...
- **"Auditable in an afternoon"**: the entire framework is ~3 000 lines of Python with one runtime dependency. Any competent developer can read and understand the full source in a working day. This is a design constraint, not an accident.
