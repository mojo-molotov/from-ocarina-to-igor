...
- **KISS as a filter**: every feature, shortcut, and DSL that was refused was refused by applying KISS. The result is ~3 000 lines with one runtime dependency (`selenium`).
