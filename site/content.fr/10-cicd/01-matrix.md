...
| `ocarina`                 | `dev_ci.yml`                     | push dev/feature/fix, PR&nbsp;dev, dispatch | ubuntu&nbsp;×&nbsp;py&nbsp;3.14                                                                     | venv cache                                                     | check-coding-style + test + récap couverture (non bloquant)                        | [`02-ocarina-workflows.md`](02-ocarina-workflows.md)       |
