...
# 99.02&nbsp;—&nbsp;Index des fichiers cités

> Par dépôt, les fichiers source explicitement cités dans le précis. URLs GitHub directs.
...
- [`docs/fr/index.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/index.md)
- [`docs/fr/what-is-it.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/what-is-it.md)
- [`docs/fr/first-feedbacks.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/first-feedbacks.md)
- [`docs/fr/setup.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/setup.md)
- [`docs/fr/scenarios-composability.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/scenarios-composability.md)
- [`docs/fr/datasets-smoke-tests-setup-teardown-proxy-api-and-caching.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/datasets-smoke-tests-setup-teardown-proxy-api-and-caching.md)
- [`docs/fr/handling-flakiness.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/handling-flakiness.md)
- [`docs/fr/extensibility.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/extensibility.md)
- [`docs/fr/using-ocarina-with-ai.md`](https://github.com/mojo-molotov/ocarina-holy-book/blob/main/docs/fr/using-ocarina-with-ai.md)
