...
| ------------------------- | -------------------------------------------------------------------------------------------------- | ---------- | :-------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | :------: |
| `ocarina`                 | Framework de test e2e navigateur                                                                   | Python     | **3.14+** | `hatchling`, `python-docx` (seule dépendance d'exécution), `selenium` (dev seulement)                                                                                                | `ruff` (ALL), `mypy` strict, `pytest`, `hypothesis`, `pytest-mypy-plugins`, `syrupy`, `prysk` (cram), `allure-pytest`, `pre-commit`, `twine`, `build`                                                                                       | PyPI, v**1.1.+**                                 |   MIT    |
...
- Selenium n'est même pas une dépendance d'exécution d'Ocarina, c'est une dépendance du _groupe `dev`_ (utilisée par les tests, pas par la lib).
