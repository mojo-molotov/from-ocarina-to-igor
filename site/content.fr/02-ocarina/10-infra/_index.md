...
| 06  | [`06-playwright-actor.md`](06-playwright-actor.md)   | L'acteur `PlaywrightDriver`&nbsp;: thread propriétaire, marshalling par `submit`, `call_timeout` de liveness, warmup cross-thread, Watcher observe-only. |
