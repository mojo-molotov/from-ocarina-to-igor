...
>
> Tout ce qui matérialise les abstractions (`POMBase`, `WebDriversPool`, `Screenshotter`) en version Selenium. **Vit hors du DSL pur**&nbsp;; un projet Playwright remplacerait simplement ce dossier.
