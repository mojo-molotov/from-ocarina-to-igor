...
description: "L'identité technique d'Ocarina via son pyproject.toml : nom, version 1.1.9, Python 3.14+, dépendances minimales et toolchain de qualité."
weight: 1
date: 2026-05-20
series: ["ocarina"]
series_order: 1
...
1. **`version = "1.1.9"`**&nbsp;: le projet est en _stable 1.x_, pas en pré-version.
